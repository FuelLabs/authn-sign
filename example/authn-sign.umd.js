(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.authnSign = {}));
  ...
  async function cryptoKeyToHex(cryptoKey) {
    return bufferToHex(await crypto.subtle.exportKey("raw", cryptoKey));
  }
  ...
  function concatHexStrings(value1, value2) {
  ...
  function removeBase64Padding(data) {
  ...
  class Account {
    ...
    async sign(challenge = "0x", options) {
      ...
      const clientHash = await sha2563(parseBase64url(clientData));
  ...
  exports.cryptoKeyToHex = cryptoKeyToHex;
  exports.decode_signature = decode_signature;
  exports.default = Account;
  exports.encode_signature = encode_signature;
  exports.hexToBase64 = hexToBase64;
  exports.hexToBuffer = hexToBuffer;
  exports.isBase64url = isBase64url;
  exports.navigatorObject = navigatorObject;
  exports.normalizeSignature = normalizeSignature;
  exports.parseBase64url = parseBase64url;
  exports.parseBuffer = parseBuffer;
  exports.parseCryptoKey = parseCryptoKey;
  exports.parseHexString = parseHexString;
  exports.recover = recover;
  exports.removeBase64Padding = removeBase64Padding;
  exports.sha256 = sha2563;
  exports.simulate_onchain_verification = simulate_onchain_verification;
